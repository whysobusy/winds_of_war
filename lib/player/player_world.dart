...
class PlayerWorld extends SimplePlayer with Lighting, ObjectCollision, FactionMixin {
  double attack = 25;
  double stamina = 100;
  ...
  PlayerWorld(Vector2 position, {required this.info})
      : super(
  ...
  void joystickAction(JoystickActionEvent event) {
    ...
    if (event.id == LogicalKeyboardKey.keyZ.keyId &&
        event.event == ActionEvent.DOWN) {
          print("move right");
      gameRef.camera.moveToPositionAnimated(Vector2(gameRef.camera.position.x+1000, gameRef.camera.position.y));
    }
